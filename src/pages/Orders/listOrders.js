...
const ListOrders = () => {
  ...
  const handleSearch = async () => {
    ...
    try {
      ...
      const response = await fetch(`http://178.16.139.77:8000/api/v1/orders-filters?user_email=${filters?.emailSearch}&order_date_from=${filters?.fromDate}&order_date_to=${filters?.toDate}&order_id=${filters?.searchOrderID}`, {
        headers: {
          Authorization: `Bearer ${accessToken}`,
          "Content-Type": "application/json",
        },
  ...
  const sendRequest = (accessToken, requestBody, id) => {
    return fetch(`http://178.16.139.77:8000/api/v1/orders/${id ? id : getID}/update-status/`, {
      method: "PATCH",
      headers: {
        Authorization: `Bearer ${accessToken}`,
        "Content-Type": "application/json",
  ...
  const SubmitDeliveryDetails = async () => {
    ...
    return await fetchWithAuth(`http://178.16.139.77:8000/api/v1/delivery-persons/`, {
      method: "POST",
      headers: { "Content-Type": "application/json" },
  ...
  const fetchOrders = async (type) => {
    ...
    try {
      ...
      let apiurl;
      if (type === "1") {
        apiurl = "http://178.16.139.77:8000/api/v1/orders/"
      } else if (type === "2") {
        apiurl = "http://178.16.139.77:8000/api/v1/orders/status/Accepted/"
      } else if (type === "3") {
        apiurl = "http://178.16.139.77:8000/api/v1/orders/status/Cancelled/"
      } else if (type === "4") {
        apiurl = "http://178.16.139.77:8000/api/v1/orders/status/Assigned to Delivery Partner/"
      } else if (type === "5") {
        apiurl = "http://178.16.139.77:8000/api/v1/orders/status/Delivered/"
      }
  ...
  const fetchStatus = async () => {
    ...
    try {
      ...
      const response = await fetch("http://178.16.139.77:8000/api/v1/order-status/", {
        headers: {
          Authorization: `Bearer ${accessToken}`,
          "Content-Type": "application/json",
        },
